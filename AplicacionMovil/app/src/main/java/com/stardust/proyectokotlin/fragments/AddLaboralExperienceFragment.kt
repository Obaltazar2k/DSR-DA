...
class AddLaboralExperienceFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        spinnerKindOfJob.adapter = arrayAdapter2
        ...
        bttnAdd.setOnClickListener() {
            ...
            if (jobCategory.isNotEmpty() && kindOfJob.isNotEmpty() && title.isNotEmpty() && organization.isNotEmpty() && country.isNotEmpty() &&
                ...
                laboralExperience.job_category = kindOfJob.toUpperCase(Locale.ROOT)
                laboralExperience.sector = jobCategory.toUpperCase(Locale.ROOT)
                ...
                //laboralExperience.current_job = false
